...
const startMessage = `
Hi {} 😉️,
I'm <b>Torrent To Team Drive</b> 😇️, A Bot By <b>@NexaBotsUpdates</b> 😁️.
...
<b>Note ⚠️: Before Doing These Commands Please <a href="https://t.me/NexaBotsUpdates/48">Read My Commands Usage</a></b>

<code>/start</code> - Start Me 🙂️
<code>/download</code> - To Download A Torrent 😆️
<code>/remove</code> - To Remove Downloading Torrent 😌️
<code>/details</code> - To Get Detail Of Torrent 🤗️
<code>/status</code> - To Get Status Of Torrent 🧐️
...
function bot(torrent, bot) {
  ...
  bot.on("message", async msg => {
    ...
    bot.sendMessage(chatId, "Uploading Your File... Wait and Join <b>@NexaBotsUpdates</b> ❤️");
    try {
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      bot.sendMessage(from, "Starting to download... Wait and Join <b>@NexaBotsUpdates</b> ❤️");
      try {
